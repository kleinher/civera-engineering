export default {
  ...
  nav: {
    ...
    visualisation: 'Design & Visualisation',
    about: 'About',
    contact: 'Contact',
  ...
  experience: {
    ...
    items: {
      ...
      steel: {
        ...
        desc: 'Design and verification of bolted and welded connections, base plates, bracing, secondary steel and structural interfaces.',
      },
      international: {
      ...
      review: {
        ...
        desc: 'Technical review, multidisciplinary coordination, quantities, documentation and project delivery support.',
      },
    },
    strip: {
      geo: {
      ...
      teams: {
        ...
        desc: 'Collaboration with international teams and specialists.',
      },
      quality: {
        title: 'Quality & Reliability',
        desc: 'Technical rigour, clear communication and on-time delivery.',
      },
    },
  },
  visualisation: {
  ...
  process: {
    ...
    steps: {
      requirements: {
        title: 'Requirements',
        desc: 'We understand your project, scope and objectives.',
      },
      analysis: { title: 'Analysis', desc: 'We analyse loads, geometry and structural behaviour.' },
      design: { title: 'Design', desc: 'We develop safe, efficient and constructible solutions.' },
      documentation: {
        title: 'Documentation',
        desc: 'We prepare calculations, drawings and technical specifications.',
      },
      delivery: { title: 'Delivery', desc: 'We deliver coordinated and reliable engineering.' },
    },
    aside1:
      'We define the scope, design criteria, deliverables and responsibilities before starting each assignment.',
    aside2:
      'Engineering work is developed through coordinated analysis, internal review and documented delivery.',
    aside3:
      'Where local statutory approval or certification is required, final approval remains under the responsibility of the appointed locally qualified professional.',
  },
  about: {
    title: 'About Civera',
  ...
  contact: {
    ...
    fields: {
      ...
      uploadHint: 'PDF, DOCX, XLSX, DWG, DXF, IFC or ZIP (max 20 MB).',
      selectOption: 'Select a project type',
    },
    projectTypes: {
      rc: 'Reinforced Concrete Structure',
      steel: 'Structural Steel Structure',
      foundation: 'Foundation Engineering',
      connections: 'Steel Connections',
  ...
  project: {
    ...
    galleryCategories: {
      ...
      reinforcement: 'Reinforcement and Concrete Works',
      model: 'Structural 3D Model',
      render: 'Architectural Render',
      drawings: 'Structural Drawings',
      foundation: 'Foundation Drawings',
